      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="py-16 md:py-20 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="font-brand text-2xl font-semibold tracking-[0.12em]">
              MATTEEKAY <span className="font-light">FASHION</span>
            </h3>
            <p className="font-body text-sm leading-relaxed text-primary-foreground/60 max-w-xs">
              Where elegance meets the extraordinary. Crafting timeless couture for the modern connoisseur.
            </p>
          </motion.div>
