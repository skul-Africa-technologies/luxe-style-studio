...
const FeaturedCollectionShowcase = () => {
  ...
  if (loading) {
    return (
      <section className="pt-24 pb-12 md:pt-32 md:pb-24 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
  ...
  return (
    <section
      id="collection"
      className="pt-24 pb-12 md:pt-32 md:pb-24 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto"
