      ...
      <div className="flex gap-2">
        ...
        {!outOfStock && (
          <button
            ...
            className="h-11 px-4 flex items-center justify-center border border-border rounded-xl uppercase text-xs tracking-widest hover:bg-black hover:text-white transition-colors duration-300"
          >
            WhatsApp
          </button>
        )}
      ...
      <div className="space-y-5 lg:sticky lg:top-28">
        ...
        <div className="space-y-3">
          ...
          {!outOfStock && (
            <button
              onClick={handleWhatsappOrder}
              className="w-full py-4 border text-center uppercase text-xs tracking-widest block hover:bg-black hover:text-white transition-colors duration-300"
            >
              Order via WhatsApp
            </button>
          )}
    ...
    >
      ...
      <div className="p-4 space-y-3">
        ...
        {!outOfStock && (
          <button
            onClick={handleWhatsappOrder}
            className="w-full h-10 mt-1 flex items-center justify-center border rounded-xl uppercase text-xs tracking-widest hover:bg-black hover:text-white transition-colors duration-300"
          >
            WhatsApp
          </button>
        )}
    ...
    >
      ...
      <div className="flex gap-2">
        ...
        {!outOfStock && (
          <button
            onClick={handleWhatsappOrder}
            className="w-11 h-11 flex items-center justify-center rounded-xl border hover:bg-black hover:text-white transition-colors duration-300"
          >
            <svg
              width="16"
              height="16"
